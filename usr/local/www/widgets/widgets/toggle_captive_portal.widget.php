...
<form name=internet_control action="/widgets/widgets/toggle_captive_portal.widget.php" method="post" class="form-horizontal">
    <div class="container">
        <div class="row">
            <div class="col-xs-2 col-sm-10 col-md-5 col-sm-offset-0 col-md-offset-0">
                <div class="panel panel-default">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            Block all business internet access except for
                            <input <?echo($toggledisable);?> type='text' size=12 id='ipaddr' name='ipaddr' placeholder="XXX.XXX.XXX.XXX" value=<?echo($ban_all_ip);?>>
                            <div class="material-switch pull-right">
