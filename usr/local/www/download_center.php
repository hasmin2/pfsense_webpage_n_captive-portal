...
function print_download_link($title, $image, $filename){
    ...
    array_push($help_menu, array(gettext("NexusWave Guide - English"), "manual.png", "NexusWave User guide latest-Eng.pdf"));
    array_push($help_menu, array(gettext("NexusWave Guide - Korean"), "manual.png","NexusWave User guide latest-Kor.pdf"));
