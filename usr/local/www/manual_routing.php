...
$pgtitle = array(gettext("Status"), gettext("Manual_routing"));
$pglinks = array("", "@self");
$shortcut_section = "manual_routing";
include("head.inc");

/* active tabs */
$tab_array = array();
$tab_array[] = array(gettext("Gateways"), true, "manual_routing.php");
display_top_tabs($tab_array);
?>
<div class="panel panel-default">
	<div class="panel-heading"><h2 class="panel-title"><?=gettext('Manual Routing')?></h2></div>
